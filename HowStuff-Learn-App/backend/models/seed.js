...
const seedData = async () => {
    try {
        ...
        const userData = {
            username: 'Rameawwe',
            email: 'sdieqwwr@example.com',
            password: 'RamawqdwPasswor,d123!',  // Ideally, this should be hashed
        ...
        await Notification.create([
            ...
            {
                userId: userId,
                message: 'New assignment available: AR Quiz on Biology',
                type: 'Assignment', // Valid type
                read: false,
                targetAudience: 'Student',
                createdAt: new Date()
            ...
            {
                userId: tempUserId,
                message: 'Upcoming AR lecture: Quantum Physics in 2 days (Temporary User)',
                type: 'Assignment', // Valid type
                read: false,
                targetAudience: 'Student',
                createdAt: new Date()
            ...
            {
                userId: tempUserId,
                message: 'New quiz available: Biology AR Quiz (Temporary User)',
